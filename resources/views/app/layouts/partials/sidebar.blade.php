<header class="main-nav @if(!auth()->user()) close_icon @endif">
    <div class="sidebar-user text-center" >
        <img class="" src="{{asset('assets/img/Library.png')}}" alt="" width="180px" height="130px" style="border-width: 0px;"/>
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    @else
                        ...
                        <li class="dropdown">
                            <a class="nav-link menu-title link-nav {{routeActive('index')}}" href="{{ route('index') }}"><i data-feather="globe"></i><span>Welcome</span></a>
                        </li>
                        <li class="dropdown">
