                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-8 col-sm-12 offset-lg-2">
                            <form method="POST" action="<?php echo e(route('books.store')); ?>" id="createForm" onsubmit="submittedForm()">
                                <?php echo csrf_field(); ?>

                                <div class="row">
                                    <div class="mb-3 col-sm-12">
                                        <label for="bookTitle">Title</label>
                                        <input class="form-control" id="bookTitle" type="text" name="title" value="<?php echo e(old('title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        ...
                                        <input class="form-control" id="authorName" type="text" name="author" value="<?php echo e(old('author')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        ...
                                        <input class="form-control" id="year" type="number" min="1600" max="2099" value="<?php echo e(old('year') ?? '2000'); ?>" name="year">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        ...
                                        <input class="form-control" id="availStock" type="number" min="0" name="avail_stock" value="<?php echo e(old('avail_stock')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        ...
                                        <input class="form-control" id="inputAddress5" type="number" min="0" name="total_stock" value="<?php echo e(old('total_stock')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="order-place d-flex justify-content-center">
                ...
                <a class="btn btn-info mx-2" href="<?php echo e(route('books.index')); ?>">Cancel</a>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Laravel\librarySystem\resources\views/app/admin/books/create.blade.php ENDPATH**/ ?>