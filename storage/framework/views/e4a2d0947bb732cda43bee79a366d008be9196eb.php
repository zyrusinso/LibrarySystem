                    ...
                    <div class="row">
                        <div class="col-xl-6 col-xs-12 col-md-6 col-sm-6">
                            <div class="cal-info text-center">
                                <div>
                                    <h2><?php echo e(date('d')); ?></h2>
                                    <div class="d-inline-block"><span class="b-r-dark pe-3"><?php echo e(date('F')); ?></span><span
                                            class="ps-3"><?php echo e(date('Y')); ?></span></div>
      ...
      &lt;/div&gt;</code></pre>
        ...
        <div class="col-xl-4 col-md-6 box-col-6">
            <div class="card custom-card">
                <div class="card-header pb-0"><img class="img-fluid" src="<?php echo e(asset('assets/images/user-card/3.jpg')); ?>"
                        alt=""></div>
                <div class="card-profile"><img class="rounded-circle" src="<?php echo e(asset('assets/images/avtar/3.jpg')); ?>"
                        alt=""></div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="bd-t-none u-s-tb">
                                        <div class="align-middle image-sm-size">
                                            <img class="img-radius align-top m-r-15 rounded-circle"
                                                src="<?php echo e(asset('assets/images/user/5.jpg')); ?>" alt="">
                                            <div class="d-inline-block">
                                ...
                                <tr>
                                    <td class="bd-t-none u-s-tb">
                                        <div class="align-middle image-sm-size">
                                            <img class="img-radius align-top m-r-15 rounded-circle"
                                                src="<?php echo e(asset('assets/images/user/6.jpg')); ?>" alt="">
                                            <div class="d-inline-block">
                                ...
                                <tr>
                                    <td class="bd-t-none u-s-tb">
                                        <div class="align-middle image-sm-size">
                                            <img class="img-radius align-top m-r-15 rounded-circle"
                                                src="<?php echo e(asset('assets/images/user/7.jpg')); ?>" alt="">
                                            <div class="d-inline-block">
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Laravel\librarySystem\resources\views/app/app.blade.php ENDPATH**/ ?>