            ...
            <div class="card profile-greeting">
                ...
                <div class="card-body text-center p-t-0">
                    ...
                    <p>Welcome to the Quezon City University Library! we are glad that you are visite the library. we will be happy to
                        ...
                        <a href="<?php echo e(route('index')); ?>" class="btn btn-light">Visitors</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xl-8 col-sm-12 offset-lg-2">
                    <form method="POST" action="<?php echo e(route('borrow.store')); ?>" id="borrowForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-sm-6">
                                <div>
                                    ...
                                    <textarea class="form-control" id="remarksArea" rows="3" name="remarks"><?php echo e(old('remarks')); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Laravel\librarySystem\resources\views/app/borrow.blade.php ENDPATH**/ ?>