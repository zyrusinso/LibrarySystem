                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p><span style="color: #168eea;"><?php echo e($borrow->fname); ?> <?php echo e($borrow->lname); ?></span></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <table class="order-detail" width="100%">
                            <tbody>
                                <tr width="100vh">
                                    ...
                                    <td class="price" colspan="3" style="line-height: 49px; text-align: right; padding-right: 28px; font-size: 13px; color: #000000; text-align: right; border-left: unset;"><b><?php echo e($book->title); ?></b></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="price" colspan="3" style="line-height: 49px; text-align: right; padding-right: 28px; font-size: 13px; color: #000000; text-align: right; border-left: unset;"><b><?php echo e($book->author); ?></b></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="price" colspan="3" style="line-height: 49px; text-align: right; padding-right: 28px; font-size: 13px; color: #000000; text-align: right; border-left: unset;"><b><?php echo e($book->year); ?></b></td>
                                </tr>
                            </tbody>
                        </table>
                                    ...
                                    <td style="padding: 30px;">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a href="<?php echo e(route('borrow')); ?>" style="color: #168eea; font-size: 14px; text-transform: capitalize; font-weight: 600; margin: 0; text-decoration: underline;">Go back to Borrowing Page</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
...
<?php /**PATH G:\xampp\htdocs\Laravel\librarySystem\resources\views/app/components/borrow.blade.php ENDPATH**/ ?>