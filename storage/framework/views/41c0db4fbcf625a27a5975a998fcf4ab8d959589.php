...
unset($__errorArgs, $__bag); ?>
                        ...
                        <p>This login is only for administrator and staff<a class="ms-2" href="<?php echo e(route('index')); ?>" style="color:#0d6efd !important">Go back</a></p>
                    </form>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('auth.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Laravel\librarySystem\resources\views/auth/login.blade.php ENDPATH**/ ?>